...
export default function Education() {
  return (
    <div className="md:col-span-1 col-span-3 border-stone-300 border-r-2 border-t-2">
      <h2 className="mb-10 text-2xl font-semibold text-center text-gray-400 m-6">Educación</h2>
      <SimpleCard text="Bootcamp Academia X" link="https://drive.google.com/file/d/1sMSJjIj2y_YG8cozKqx31aq4W43YLdDc/view?usp=sharing" />
