                            ...
                            <figure>
                                ...
                                <figcaption className="p-4">
                                    ...
                                    <div className='flex w-full p-2 justify-between'>
                                        ...
                                        <a href={post.web} target="_blank" className="text-white bg-green-600 hover:bg-green-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 animate__animated animate__fadeInLeft  animate__slower">
