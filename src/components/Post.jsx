        ...
        <div key={index} className="my-8 rounded shadow-lg shadow-gray-200  bg-white duration-300 hover:-translate-y-1  ">
            <div className="cursor-pointer h-full">
                ...
                <div className='flex w-full p-4 justify-between bottom-1 min-h-[60px]'>
                    <a href={git} target="_blank" rel="noopener noreferrer" className="text-white bg-blue-600 hover:bg-blue-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center ">
