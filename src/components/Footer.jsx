        ...
        <section className="bg-white relative">
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                    ...
                    <div className="px-5 py-2">
                        <Link to={"/proyects"} className="text-base leading-6 text-gray-500 hover:text-gray-900">
                            Proyects
                        </Link>
                    </div>
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    <a href="https://www.linkedin.com/in/jeremy-tierra-0638061a9/" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noreferrer" >
                        <span className="sr-only">Linkedind</span>
                        <svg className="w-6 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://github.com/JeremyTierra" className="text-gray-400 hover:text-gray-500" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://www.instagram.com/jeremytierra_25/" target="_blank" className="text-gray-400 hover:text-gray-500" rel="noreferrer">
